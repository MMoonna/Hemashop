...
import { getPreOrderAPI } from '@/services/order'
...
<template>
  <scroll-view scroll-y class="viewport">
    ...
    <view class="settlement">
      <view class="item">
        ...
        <text class="number symbol">{{ preorder?.summary.totalPrice }}</text>
      </view>
      <view class="item">
        <text class="text">运费: </text>
        <text class="number symbol">{{ preorder?.summary.postFee }}</text>
      </view>
    </view>
  </scroll-view>
  ...
  <view class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
    <view class="total-pay symbol">
      <text class="number">{{ preorder?.summary.totalPayPrice }}</text>
    </view>
